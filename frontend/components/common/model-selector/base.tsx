  ...
  const trigger = (
    ...
    >
      <div className="flex items-center gap-1.5">
        {currentProvider?.icon && <currentProvider.icon className="size-3.5" />}
          ...
          <TooltipTrigger asChild>
            <PopoverTrigger asChild>
              <Button
                ...
                variant="secondary"
                className={cn(
                  "border-border dark:bg-secondary text-accent-foreground h-7 w-auto border bg-transparent text-xs",
                  className
                )}
                type="button"
              >
